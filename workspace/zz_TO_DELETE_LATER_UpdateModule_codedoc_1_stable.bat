...
rem This script is now obsolete because develoment branch has merged into
rem master.
rem The script clones the codedoc repository into a different directory,
rem codedoc_1_stable (such that both branches can be worked on).
