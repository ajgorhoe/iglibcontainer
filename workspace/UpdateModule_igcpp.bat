...
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.workspace.igcpp.git
rem Non-overridable:
set RepositoryAddressSecondary=https://gitlab.com/ajgorhoe/iglib.workspace.igcpp.git
set RepositoryAddressLocal=d:/backup_sync/bk_code/git/ig/workspace/igcpp.git
set Remote=origin
