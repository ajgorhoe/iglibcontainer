...
set RepositoryAddressSecondary=https://gitlab.com/ajgorhoe/iglib.workspace.z_courses.git
set RepositoryAddressLocal=d:/backup_sync/bk_code/git/ig/workspace/z_courses.git
set Remote=origin
