...
set ModuleDirRelative=WordSimplesWpfMvvm
set RepositoryAddress=https://github.com/MarkWithall/worlds-simplest-csharp-wpf-mvvm-example.git
set CheckoutBranch=C#9.0
set Remote=origin
