...
# IMPORTANT REMARK: 
# This was used for development of new scripts, and it is NOT USED any more.
# Repository is only on GitLab and local, but NOT on GitHub.
# Code generation in this repo may not work.
# Repository and this script are kept just in case that one would like
# to look for something from it.
...
$global:CurrentRepo_Directory = "codedoc_new_NotUsed/"
$global:CurrentRepo_Ref = "main"
$global:CurrentRepo_Address = "https://gitlab.com/ajgorhoe/iglib.workspace.codedoc_develop.git"
$global:CurrentRepo_Remote = "origin"
$global:CurrentRepo_AddressSecondary = ""
$global:CurrentRepo_RemoteSecondary = "remoteSecondary"
$global:CurrentRepo_AddressTertiary = "d:/backup_sync/bk_code/git/ig/workspace/codedoc_new"
