...
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.workspace.base.igsandbox.git
set RepositoryAddressSecondary=https://gitlab.com/ajgorhoe/iglib.workspace.base.igsandbox.git
set RepositoryAddressLocal=d:/backup_sync/bk_code/git/ig/workspace/base/igsandbox.git
set Remote=origin
