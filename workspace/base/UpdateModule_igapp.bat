...
set ModuleDirRelative=igapp
set CheckoutBranch=master
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.workspace.base.igapp.git
set RepositoryAddressSecondary=https://gitlab.com/ajgorhoe/iglib.workspace.base.igapp.git
set RepositoryAddressLocal=d:\backup_sync\bk_code\git\ig\workspace\base\igapp.git
set Remote=origin
