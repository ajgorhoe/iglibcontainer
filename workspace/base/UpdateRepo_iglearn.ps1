...
$global:CurrentRepo_AddressSecondary = "https://gitlab.com/ajgorhoe/iglib.workspace.base.iglearn.git"
$global:CurrentRepo_RemoteSecondary = "remoteGitLab"
$global:CurrentRepo_AddressTertiary = "d:/backup_sync/bk_code/git/ig/workspace/base/iglearn.git"
