...
set ModuleDirRelative=igtest
set CheckoutBranch=release/IGLib1.9.9_21_11_18_MainApplicationsWork
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.workspace.base.igtest.git
set RepositoryAddressSecondary=https://gitlab.com/ajgorhoe/iglib.workspace.base.igtest.git
set RepositoryAddressLocal=d:/backup_sync/bk_code/git/ig/workspace/base/igtest.git
set Remote=origin
