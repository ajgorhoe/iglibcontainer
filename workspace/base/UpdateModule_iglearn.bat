...
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.workspace.base.iglearn.git
set RepositoryAddressSecondary=https://gitlab.com/ajgorhoe/iglib.workspace.base.iglearn.git
set RepositoryAddressLocal=d:/backup_sync/bk_code/git/ig/workspace/base/iglearn.git
set Remote=origin
