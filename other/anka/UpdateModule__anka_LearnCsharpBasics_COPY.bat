...
set ModuleDirRelative=anka_LearnCsharpBasics_COPY
set CheckoutBranch=main
set RepositoryAddress=https://github.com/ajgorhoe/LearnCsharpBasics.git
rem     https://github.com/AnkitaMega/LearnCsharpBasics.git
