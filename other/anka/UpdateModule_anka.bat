...
set ModuleDirRelative=anka
set CheckoutBranch=master
set RepositoryAddress=https://gitlab.com/ajgorhoe/iglib.workspaceprojects.anka.git
rem Non-overridable:
set RepositoryAddressSecondary=https://github.com/ajgorhoe/IGLib.workspaceprojects.anka.git
set RepositoryAddressLocal=d:\backup_sync\bk_code\git\ig\workspaceprojects\anka.git
set Remote=origin
