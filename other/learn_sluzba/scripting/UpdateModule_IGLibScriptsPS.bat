...
set ModuleDirRelative=IGLibScriptsPS
set CheckoutBranch=mainPS
# fork/GLibScriptsPS/main_PowerShell
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.modules.IGLibScriptsPS.git
set RepositoryAddressSecondary=%~dp0\IGLibScripts
set RepositoryAddressLocal=
set Remote=origin_PowerShellScripts
set RemoteSecondary=upstream_Scripts
