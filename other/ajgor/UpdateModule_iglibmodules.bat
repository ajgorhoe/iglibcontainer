...
set ModuleDirRelative=iglibmodules
set CheckoutBranch=main
set RepositoryAddress=https://github.com/ajgorhoe/iglibmodules.git
set RepositoryAddressSecondary=
rem https://gitlab.com/ajgorhoe/web.git
set RepositoryAddressLocal=d:/backup_sync/bk_code/git/ig/IGLibModules.git
set Remote=origin
