...
set ModuleDirRelative=learn_sluzba
set CheckoutBranch=master
set RepositoryAddress=https://github.com/ajgorhoe/IGLib.workspace.base.iglearn_sluzba.git
set RepositoryAddressSecondary=
set RepositoryAddressLocal=d:\backup_sync\bk_code\git\ig\workspace\base\iglearn_sluzba.git
set Remote=origin
